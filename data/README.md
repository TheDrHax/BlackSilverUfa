...
"225279322": {
  "segments": [
    ...
    { "vk": "87862793_456241095", "offset": "3:46:12" }
  ],
...
Этот объект похож на объект "Стрим" за исключением того, что в нём не применяются поля, отмеченные \*\*. Для второго и последующих сегментов крайне рекомендуется добавлять поле `offset`, так как файл субтитров на все сегменты один, а смещение от начала стрима у них разное.
