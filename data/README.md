...
| `vk`<sup>*</sup> | Нет | ID видео в социальной сети ВКонтакте. **Важно**: Поддержка прекращена из-за противодейстивя ВКонтакте. Теперь этот ключ только добавляет ссылку на видео. |
