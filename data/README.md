...
```
"654380816": {  },
"655265437": { "offset": "-7:32:13" },
"655528246": { "offset": "-14:13:20" },
"656257835": { "offset": "-17:13:32" },
...
Объединённые стримы пока что поддерживают только один сегмент. При указании нескольких сегментов будет возвращена ошибка.
