...
<h2 id="225279322">
  <a id="11" href="#225279322">12</a>
</h2>

* Примечание: Официальной записи не будет
* Ссылки:
  * Twitch: [225279322](https://www.twitch.tv/videos/225279322)
  * Субтитры: [v225279322.ass](../chats/v225279322.ass)
  * Запись сегментирована:
      * Часть 1 (ВКонтакте): [87862793_456241096](https://vk.com/video87862793_456241096)
      * Часть 2 (ВКонтакте): [87862793_456241095](https://vk.com/video87862793_456241095)
...
<a onclick="return openPlayer1200()" id="button-1200">**▶ Часть 1**</a>

<script>
  var player1200;
  function openPlayer1200() {
    player1200 = videojs("player-1200", {
      controls: true, nativeControlsForTouch: false,
      width: 640, height: 360, fluid: true,
      plugins: {
        ass: {
      ...
      sources: [{
        "type": "video/mp4",
        "src": "https://api.thedrhax.pw/vk/video/87862793_456241096?redirect"
      }]
    });
    document.getElementById("spoiler-1200").click();
    document.getElementById("button-1200").remove();
    return false;
  }
</script>

<details>
  <summary id="spoiler-1200"></summary>

  <div class="player-wrapper" style="margin-top: 32px">
    <video id="player-1200" class="video-js vjs-default-skin vjs-big-play-centered" />
  </div>
</details>
...
if (window.location.hash) {
  var id = window.location.hash.replace('#', '');
  if (id == "1200" || id == "225279322")
    openPlayer1200();
}
</script> 
 
<a onclick="return openPlayer1201()" id="button-1201">**▶ Часть 2**</a>

<script>
  var player1201;
  function openPlayer1201() {
    player1201 = videojs("player-1201", {
      controls: true, nativeControlsForTouch: false,
      width: 640, height: 360, fluid: true,
      plugins: {
        ass: {
      ...
      sources: [{
        "type": "video/mp4",
        "src": "https://api.thedrhax.pw/vk/video/87862793_456241095?redirect"
      }]
    });
    document.getElementById("spoiler-1201").click();
    document.getElementById("button-1201").remove();
    return false;
  }
</script>

<details>
  <summary id="spoiler-1201"></summary>

  <div class="player-wrapper" style="margin-top: 32px">
    <video id="player-1201" class="video-js vjs-default-skin vjs-big-play-centered" />
  </div>
</details>
...
```
mpv --sub-file chats/v225279322.ass --merge-files https://api.thedrhax.pw/vk/video/87862793_456241096\?redirect https://api.thedrhax.pw/vk/video/87862793_456241095\?redirect
```
